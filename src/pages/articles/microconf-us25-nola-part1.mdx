...
export const meta = {
  author: 'Zack Gilbert',
  date: '2025-03-19',
  title: 'MicroConf US25 - NOLA - Before the Conference (Part 1)',
  description:
    'A detailed stream of consciousness recap of the first couple of days before the actual start of MicroConf 2025 in New Orleans.',
}
...
I realized that I really haven’t taken much time to slow down and quietly think much on this trip. It’s largely been go go-go-go and a lot of socializing.
